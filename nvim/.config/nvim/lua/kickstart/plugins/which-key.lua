return {
  {
    ...
    config = function()
      require('which-key').add {
        ...
        { '<leader>mn', desc = 'Next Hunk', icon = { icon = '', color = 'red' } },
        { '<leader>mp', desc = 'Previous Hunk', icon = { icon = '', color = 'red' } },
        { '<leader>ms', desc = 'Stage Hunk', icon = { icon = '', color = 'red' } },
        { '<leader>mu', desc = 'Unstage Hunk', icon = { icon = '', color = 'red' } },
        { '<leader>mv', desc = 'Preview Hunk', icon = { icon = '', color = 'red' } },
        { '<leader>mb', desc = 'Blame', icon = { icon = '', color = 'red' } },
